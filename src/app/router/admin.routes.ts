  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () => import('../views/admin/orders.component').then(c => c.OrdersComponent),
        canActivate: [protectRouteGuard],
        data: { role: 'admin' }
      },
      {
      ...
      },
      {
        ...
        loadComponent: () => import('../views/admin/deactive-sellers.component').then(c => c.DeactiveSellersComponent),
        canActivate: [protectRouteGuard],
        data: { role: 'admin' }
      },
      {
